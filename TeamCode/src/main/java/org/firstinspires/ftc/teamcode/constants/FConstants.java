...
public class FConstants {
    static {
        ...
        FollowerConstants.leftRearMotorName = "LBLE";
        FollowerConstants.rightFrontMotorName = "RFBE";
        FollowerConstants.rightRearMotorName = "RBRE";
        ...
        FollowerConstants.mass = 10.5 * 2.20462;

        FollowerConstants.xMovement = 58.5;
