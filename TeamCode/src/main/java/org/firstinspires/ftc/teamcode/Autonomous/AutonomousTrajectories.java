...
//BLUE LANDING ZONE
    ...
    public TrajectorySequence BlueBackstageLeftTrajectoryChopperPush0 = drive.trajectorySequenceBuilder(BLUE_BACKSTAGE_START_POSE)
            ...
            .splineTo(new Vector2d(-36, 23), Math.toRadians(0))
            .build();
    public TrajectorySequence BlueBackstageLeftTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-36, 23, Math.toRadians(0)))
            .setReversed(true)
            .back(10)
            .waitSeconds(1)
            .setReversed(false)
    ...
    public TrajectorySequence BlueBackstageCenterTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-30, 11, Math.toRadians(0)))
            .setReversed(true)
            .back(10)
            .waitSeconds(1)
            .setReversed(false)
    ...
    public TrajectorySequence BlueBackstageRightTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-32, 10, Math.toRadians(-90)))
            .setReversed(false)
            .splineToLinearHeading(new Pose2d(-55, 50, Math.toRadians(-90)), Math.toRadians(90))
            .build();
    ...
    public TrajectorySequence BlueLandingZoneRightTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-38, -47, Math.toRadians(0)))
            .setReversed(true)
            .back(7)
            .strafeLeft(12.5)
            .forward(33)
    ...
    public TrajectorySequence BlueLandingZoneCenterTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-31, -35, Math.toRadians(0)))
            .setReversed(true)
            .back(5)
            .strafeRight(15)
            .forward(25)
    ...
    public TrajectorySequence BlueLandingZoneLeftTrajectoryChopperPush1 = drive.trajectorySequenceBuilder(new Pose2d(-30, -34, Math.toRadians(90)))
            .setReversed(true)
            .back(5)
            .strafeRight(18)
            .lineToLinearHeading(new Pose2d(-12, 50, Math.toRadians(90)))
