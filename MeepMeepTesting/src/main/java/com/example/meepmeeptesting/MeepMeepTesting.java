...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        mySecondBot.runAction(mySecondBot.getDrive().actionBuilder(new Pose2d(15.2, -62, Math.toRadians(90)))
                ...
                /*break - Score first specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(6, -35), Math.toRadians(-90))
                .splineToSplineHeading(new Pose2d(30, -39, Math.toRadians(30)), Math.toRadians(0))
                /*break - intake first sample*/ .waitSeconds(0.1)
                .turnTo(Math.toRadians(-45))
                /*break - outtake first sample*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(42, -39, Math.toRadians(30)), Math.toRadians(0))
                /*break - intake second sample*/ .waitSeconds(0.1)
                .turnTo(Math.toRadians(-45))
                /*break - outtake second sample*/ .waitSeconds(0.1)
                .turnTo(Math.toRadians(90))
                /*break - outtake second sample*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(-90))
                .splineToSplineHeading(new Pose2d(42, -59, Math.toRadians(90)), Math.toRadians(-90))
                /*break - intake second specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(90))
                .splineTo(new Vector2d(6, -34), Math.toRadians(90))
                /*break - score second specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(45, -47), Math.toRadians(-90))
                /*break - prepare to intake third specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(45, -59), Math.toRadians(-90))
                /*break - intake third specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(90))
                .splineTo(new Vector2d(6, -34), Math.toRadians(90))
                /*break - score third specimen*/ .waitSeconds(0.1)
                .setTangent(Math.toRadians(-90))
